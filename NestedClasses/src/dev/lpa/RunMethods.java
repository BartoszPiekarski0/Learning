...
public class RunMethods {
    ...
    public static void main(String[] args) {
        ...
        List<StoreEmployee> storeEmployee = new ArrayList<>(List.of(
                new StoreEmployee(10014, "Meg", 2019,
                        "Target"),
                new StoreEmployee(10515, "Joe", 2021,
                        "Walmart"),
                new StoreEmployee(10105, "Tom", 2020,
                        "Macys"),
                new StoreEmployee(10251, "Marty", 2018,
                        "Walmart"),
        ...
        sortIt(storeEmployee, c0);
        sortIt(storeEmployee, c1);
        sortIt(storeEmployee, c2);
        sortIt(storeEmployee, c3);
        sortIt(storeEmployee, c4);
        sortIt(storeEmployee, (o1, o2) -> o1.getName().compareTo(o2.getName()));
    }
